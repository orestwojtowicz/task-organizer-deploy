...
let FeedbackComponent = class FeedbackComponent {
    ...
    sendFeedback() {
        this.sending = true;
        this.apiService.postFeedback(this.model).subscribe(rest => {
            this.msg = true;
            this.sending = false;
            setTimeout(() => {
                this.sending = false;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".text-search {\n  border: none;\n  outline: none;\n}\ninput {\n  outline: none;\n  border: none;\n  background: transparent;\n  border-bottom: 1px solid #fca22b;\n}\n.notebooks-list ul > i {\n  color: red;\n\n}\n.grid-wrapper {\n  margin-top:100px;\n  display: grid;\n  grid-auto-rows: minmax(200px, auto);\n  grid-template-columns: 1fr 1fr 1fr;\n  grid-gap: 1px;\n\n\n}\n.note-wrapper {\n\n  display: grid;\n  grid-auto-rows: minmax(200px, auto);\n  grid-template-columns: 1fr 1fr 1fr;\n  grid-gap: 10px;\n\n}\n@media screen and (max-width: 780px) {\n\n  .grid-wrapper {\n   grid-template-columns: repeat(auto-fill, 300px);\n  }\n .wrapper {\n   grid-template-columns: repeat(auto-fill, 300px);\n }\n}\n@media screen and (max-width: 600px) {\n\n  .grid-wrapper > div{\n    width: 50%;\n\n  }\n\n}\n.note {\n  background: rgb(221,221,221);\n  background: linear-gradient(0deg, rgba(221,221,221,1) 0%, rgba(255,247,231,1) 18%);\n}\ntextarea {\n  background-color: transparent;\n  border:none;\n  outline: none;\n  min-width: 50px;\n  min-height: 60px;\n  max-height: 140px;\n\n\n}\n/*\n\n@Output child moze emitting events\n\n@input to parent moze do childa\n\n*/\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".text-search {\n  border: none;\n  outline: none;\n}\ninput {\n  outline: none;\n  border: none;\n  background: transparent;\n  border-bottom: 1px solid #fca22b;\n}\n.notebooks-list ul > i {\n  color: red;\n\n}\n.grid-wrapper {\n  margin-top:100px;\n  display: grid;\n  grid-auto-rows: minmax(200px, auto);\n  grid-template-columns: 1fr 1fr 1fr;\n  grid-gap: 1px;\n\n\n}\n.note-wrapper {\n\n  display: grid;\n  grid-auto-rows: minmax(200px, auto);\n  grid-template-columns: 1fr 1fr 1fr;\n  grid-gap: 10px;\n\n}\n@media screen and (max-width: 780px) {\n\n  .grid-wrapper {\n   grid-template-columns: repeat(auto-fill, 300px);\n  }\n .wrapper {\n   grid-template-columns: repeat(auto-fill, 300px);\n }\n}\n@media screen and (max-width: 600px) {\n\n  .grid-wrapper > div{\n    width: 50%;\n\n  }\n\n}\n.note {\n  background: rgb(221,221,221);\n  background: linear-gradient(0deg, rgba(221,221,221,1) 0%, rgba(255,247,231,1) 18%);\n}\ntextarea {\n  background-color: transparent;\n  border:none;\n  outline: none;\n  min-width: 50px;\n  min-height: 60px;\n  max-height: 140px;\n\n\n}\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
let NotesComponent = class NotesComponent {
    constructor(apiService, noteService) {
        this.apiService = apiService;
    ...
    createNotebook() {
        ...
        this.apiService.postNewNotebook(newNotebook).subscribe(res => {
    ...
    updateNotebook(updatedNotebook) {
        this.apiService.postNewNotebook(updatedNotebook).subscribe(res => {
        }, error => {
            alert('Cant add new notebook');
        });
    }
    ...
    deleteNote(note) {
        if (confirm("Are you sure you want to delete this note?")) {
            this.noteService.deleteNote(note.id).subscribe(res => {
    ...
    createNote(notebookId) {
        ...
        this.noteService.saveNote(newNote).subscribe(res => {
            newNote.id = res.id;
    ...
    selectNotebook(notebook) {
        ...
        this.noteService.getNotesByNotebook(notebook.id).subscribe(res => {
            this.notes = res;
        }, error => {
    ...
    updateNote(updateNote) {
        this.noteService.saveNote(updateNote).subscribe(res => {
        }, error => {
...
let NoteTextFilterPipe = class NoteTextFilterPipe {
    transform(notes, text) {
        if (text == null || text === "") {
            return notes;
        }
...
let NotesServiceService = class NotesServiceService {
    constructor(http) {
        this.http = http;
        this.BASE_URL = "http://localhost:8080";
...
NotesServiceService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
